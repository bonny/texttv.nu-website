    	...
    	foreach ($arr_contents as $key => $one_content) {
			...
			*/
			...
			if ($show_old_android_app_info) {
				...
				$old_version_info .= "\n<span class='line toprow'><a href='#' target='_blank' onclick='window.open(\"https://play.google.com/store/apps/details?id=com.mufflify.TextTVnu2\");'>Ladda</a> <a href='#' onclick='window.open(\"https://texttv.nu/android\");'>hem</a> <i onclick='alert();'>ny</i> version i Play Butik</span>";
