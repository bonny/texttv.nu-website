...
<html>
	...
	<head>
		...
		<meta property="og:title"              content="Text TV-app för iPhone och iPad" />
		<meta property="og:description"        
			  content="Med text-tv-appen från texttv.nu så får du nyheter & sportresultat snabbt och enkelt rakt in i din mobil. Se dina favoritsidor som 100, 300 och 377 i din Iphone eller Ipad." />
	...
	<body>
		...
		<div class="row">
			...
			<div class="column">
				...
				<h1 class="text-center">Text TV-app för iPhone och iPad</h1>
				
				<p>
					Med <a href="https://itunes.apple.com/se/app/texttv.nu/id607998045?mt=8">text-tv-appen från texttv.nu</a>
					så får du nyheter och sportresultat snabb och enkelt rakt in i din mobil.
				</p>
				...
				<div class="row">
					...
					<div class="column small-12 medium-8">
						...
						<ul>
							...
							<li>Se sportnyheterna på text tv 300 och resultaten text tv 377</li>
						</ul>
					...
					<div class="column small-12 medium-4 text-center">
						<a href="https://itunes.apple.com/se/app/texttv.nu/id607998045?mt=8"><img src="/ios/iphone-text-tv-app-screenshot.png"></a>
					</div>			
