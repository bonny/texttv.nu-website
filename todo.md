...
Senast uppdaterad: 2026-08-01 (+#08 säkerhetsgranskning — K1–K4 stängda och deployade, M/L kvar).
...
| 08  | Säkerhetsgranskning 2026-08-01 | **Alla fyra kritiska (K1–K4) stängda 2026-08-01** och deployade. Kvar: M1–M6 (rate limiting, CSP/headers, oembed, dev-ytor, EOL-ramverk) + L1–L8 | [todos/08-sakerhetsgranskning-2026-08-01.md](todos/08-sakerhetsgranskning-2026-08-01.md) |
