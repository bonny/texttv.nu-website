...
| 14  | `most_read`-queryn är orsaken till poolmättnaden | **TTL-höjning deployad 2026-08-11** (`X-Accel-Expires: 60`, verifierat: headern strippas, API-svar byte-identiskt, HIT i 45 s). Orsaken bakom #12. SQL-omskrivningen är verifierat korrekt men oförbättrad prestanda — ligger okommittad. **Kvar: mät effekten kvällen 2026-08-11 kl 21–22** mot 271 slowlog-träffar/h | [todos/14-most-read-queryn-ar-orsaken-till-poolmattnaden.md](todos/14-most-read-queryn-ar-orsaken-till-poolmattnaden.md) |
