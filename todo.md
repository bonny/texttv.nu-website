...
Senast uppdaterad: 2026-08-15 (#12: importerns fem tiominutersjobb utspridda över olika udda minuter och deployade — de startade tidigare samtidigt och gav 43x sämre p99 under ~20 % av tiden. Effekten mäts kvällen 2026-08-15.)
...
| 12  | php-fpm-poolen slår i taket i normaldrift | **ny rotorsak mätt 2026-08-14: importerns tiominutersjobb.** p99 1,176 s under cron-minuterna mot 0,027 s övrig tid (43x). **Utspridning deployad 2026-08-15** (fem jobb på olika udda minuter, verifierat med `schedule:list`). `cleanup-page-actions` visade sig oskyldig — dess minuter :15/:45 hade p99 0,031 s. **Kvar: mät effekten kvällen 2026-08-15.** #14:s fixar klara och verifierade | [todos/12-php-fpm-poolen-slar-i-taket.md](todos/12-php-fpm-poolen-slar-i-taket.md) |
