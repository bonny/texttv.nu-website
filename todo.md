...
Senast uppdaterad: 2026-08-01 (+#08 säkerhetsgranskning — K1–K4 + M3 stängda och deployade).
...
| 08  | Säkerhetsgranskning 2026-08-01 | **Alla fyra kritiska (K1–K4) stängda 2026-08-01** och deployade. **M3 (oembed) stängd 2026-08-01.** Kvar: M1, M2, M4, M5, M6 (rate limiting, CSP/headers, dev-ytor, EOL-ramverk) + L1–L9 | [todos/08-sakerhetsgranskning-2026-08-01.md](todos/08-sakerhetsgranskning-2026-08-01.md) |
